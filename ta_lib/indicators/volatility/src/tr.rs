...
pub fn tr(high: &Price, low: &Price, close: &Price) -> Price {
...
pub fn wtr(high: &Price, low: &Price, close: &Price) -> Price {
    let prev_close = close.shift(1);
    let diff = high - low;
...
pub fn atr(high: &Price, low: &Price, close: &Price, smooth: Smooth, period: Period) -> Price {
...
mod tests {
    ...
    fn test_true_range() {
        ...
        let result: Vec<Scalar> = tr(&high, &low, &close).into();
    ...
    fn test_wtrue_range() {
        ...
        let result: Vec<Scalar> = wtr(&high, &low, &close).into();
    ...
    fn test_atr_smma() {
        ...
        let result: Vec<Scalar> = atr(&high, &low, &close, Smooth::SMMA, period).into();
    ...
    fn test_snatr() {
        ...
        let result: Vec<Scalar> = snatr(&atr, atr_period, Smooth::WMA, period).into();
