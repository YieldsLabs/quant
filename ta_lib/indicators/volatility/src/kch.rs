...
mod tests {
    ...
    fn test_kch() {
        ...
        let factor = 2.0;
        let epsilon = 0.001;
        let expected_upper_band = [19.107, 19.123833, 19.180916, 19.221735, 19.259995, 19.348415, 19.426208, 19.478382,
            19.540155];
        let expected_middle_band = [19.107, 19.103834, 19.11425, 19.143959, 19.157478, 19.193405, 19.241535, 19.2966,
            19.355633];
        let expected_lower_band = [19.107, 19.083836, 19.047585, 19.066183, 19.054962, 19.038395, 19.056862, 19.114819,
            19.17111];
