...
mod tests {
    ...
    fn test_kbands() {
        ...
        let factor = 2.0;
        let epsilon = 0.001;
        let expected_upper_band = [2.0, 5.0, 7.265986, 9.265986, 11.265986, 12.265986, 12.265986, 9.632993, 8.632993,
            7.632993];
        let expected_middle_band = [2.0, 3.0, 4.0, 6.0, 8.0, 9.0, 9.0, 8.0, 7.0, 6.0];
        let expected_lower_band = [2.0, 1.0, 0.734014, 2.734014, 4.734014, 5.7340136, 5.7340136, 6.367007, 5.367007,
            4.367007];
